    ...
    <AuthenticatedLayout>
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b border-slate-100 pb-6 mb-8">
          <div>
            <span className="rounded bg-rose-50 border border-rose-100 px-3 py-1 text-2xs font-bold text-rose-700">
              HOSPITAL CONTROL CENTER
            </span>
            <h1 className="text-2xl font-black text-slate-900 mt-1">MediFlow Facility Status</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/admin/doctors"
              className="rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-700 shadow-md shadow-blue-100 hover:shadow-blue-200 transition-all flex items-center gap-1.5"
            >
              ...
              {[
                ...
                <div key={i} className="rounded-xl border border-slate-100 bg-white p-4 shadow-2xs text-left">
                  <div className="flex justify-between items-start gap-2">
                    <span className="text-2xs font-bold uppercase tracking-wider text-slate-400 leading-normal">{card.label}</span>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 space-y-8">
                ...
                <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  <h2 className="text-base font-bold text-slate-900 border-b border-slate-50 pb-4 mb-4">
                ...
                {mlAnalytics && (
                  <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm mt-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Top Suggested Specialties</h3>
                      ...
                      <div>
                        <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Top Booked Specialists</h3>
                    ...
                    <div className="border-t border-slate-50 pt-5">
                      <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Search Volume over Time</h3>
                    ...
                    <div className="border-t border-slate-50 pt-5">
                      <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Recent Symptom Queries</h3>
              ...
              <div className="lg:col-span-4 space-y-8 text-left">
                ...
                {/* Control Actions */}
                <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Operations Suite</h3>
                  <div className="space-y-2">
                    <Link
                      to="/admin/doctors"
                ...
                <div className="rounded-2xl border border-yellow-100 bg-yellow-50/20 p-6 shadow-2xs">
                  <div className="flex items-center gap-2 text-yellow-700">
                    ...
                    <h3 className="text-xs font-bold uppercase tracking-wider">Facility Alerts</h3>
                  </div>
